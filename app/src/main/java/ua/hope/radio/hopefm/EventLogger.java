 ...
 */
public class EventLogger implements HopeFMPlayer.Listener, HopeFMPlayer.InfoListener,
    HopeFMPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[HopeFMPlayer.RENDERER_COUNT];
  }
