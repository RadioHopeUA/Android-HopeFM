 ...
 */
public class HopeFMPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link HopeFMPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link HopeFMPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(HopeFMPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link HopeFMPlayer#onRenderers} or
     * {@link HopeFMPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public HopeFMPlayer(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link HopeFMPlayer} TYPE_* constants. An individual
